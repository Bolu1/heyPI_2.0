    ...
    <Layout title="Home">
      <div className="dark:bg-gray-800">
        ...
        <div className="dark:bg-gray-800">
          ...
          <main className="mt-2 py-0 mx-auto max-w-7xl px-4 sm:mt-2 sm:px-6 md:mt-2 lg:mt-2 lg:px-8 xl:mt-4">
                ...
                <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 :bg-coolGray-900 :text-coolGray-100">
                  <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 :bg-violet-400">
                    <svg
                      ...
                      viewBox="0 0 512 512"
                      fill="currentColor"
                      className="h-9 w-9 dark:text-gray-300"
                    >
                  ...
                  <div className="flex flex-col justify-center align-middle">
                    <p className="text-3xl font-semibold leading-none dark:text-gray-300">200</p>
                    <p className="capitalize dark:text-gray-300">Orders</p>
                  </div>
                </div>
                <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 :bg-coolGray-900 :text-coolGray-100">
                  <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 :bg-violet-400">
                  ...
                  <div className="flex flex-col justify-center align-middle">
                    <p className="text-3xl font-semibold leading-none dark:text-gray-300">7500</p>
                    <p className="capitalize dark:text-gray-300">New customers</p>
                  </div>
                </div>
                <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 :bg-coolGray-900 :text-coolGray-100">
                  <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 :bg-violet-400">
                  ...
                  <div className="flex flex-col justify-center align-middle">
                    <p className="text-3xl font-semibold leading-none dark:text-gray-300">172%</p>
                    <p className="capitalize dark:text-gray-300">Growth</p>
                  </div>
                </div>
                <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 :bg-coolGray-900 :text-coolGray-100">
                  <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 :bg-violet-400">
                  ...
                  <div className="flex flex-col justify-center align-middle">
                    <p className="text-3xl font-semibold leading-none dark:text-gray-300">17%</p>
                    <p className="capitalize dark:text-gray-300">Bounce rate</p>
                  </div>
                </div>
              </div>
            </section>
        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="container px-6 py-10 mx-auto">
                <h1 className="text-3xl font-semibold text-center text-gray-800 capitalize lg:text-4xl dark:text-white">With HeyPI you <span className="text-blue-500">can</span></h1>
                ...
                <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
                    <div className="flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl dark:bg-gray-800">
                        ...
                        <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Write APIs</h1>

                        <p className="text-gray-500 dark:text-gray-300">
                            You can write APIs store them privately or pubicly for others to see
                        </p>
                    ...
                    <div className="flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl dark:bg-gray-800">
                        ...
                        <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Search APIs</h1>

                        <p className="text-gray-500 dark:text-gray-300">
                            Search for any API you need copy and paste the code, fine tune it to meet your needs 
                        </p>
                    </div>
            ...
            <div className="container px-6 py-10 mx-auto">
                <div className="lg:flex lg:items-center">
                    <div className="w-full space-y-12 lg:w-1/2 ">
                        <div>
                            <h1 className="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">Trusted by <br/> Developers all over the world</h1>
                        ...
                        <div className="md:flex md:items-start md:-mx-4">
                            ...
                            <div className="mt-4 md:mx-4 md:mt-0">
                                <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Copy & paste APIs</h1>
                        ...
                        <div className="md:flex md:items-start md:-mx-4">
                            ...
                            <div className="mt-4 md:mx-4 md:mt-0">
                                <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Tune them to fit your needs</h1>
                        ...
                        <div className="md:flex md:items-start md:-mx-4">
                            ...
                            <div className="mt-4 md:mx-4 md:mt-0">
                                <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Get clean codes</h1>
                    ...
                    <div className="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
                        <img className="w-[28rem] h-[28rem] object-cover xl:w-[34rem] xlH-[34rem] rounded-full" src="https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=755&q=80" alt=""/>
                    </div>
                </div>

                <div className="border-gray-200 my-12 dark:border-gray-700">
