        ...
        <div className="mt-6 ">
            <div className="items-center -mx-2 md:flex">
                ...
                <div className="w-full mx-2 mt-4 md:mt-0">
                    ...
                    <input onChange={(e)=>setDescription(e.target.value)} value={description} className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" type="text" required placeholder="An Api to get date ad time on mars"/>
                </div>
            </div>
            ...
            <div className="items-center -mx-2 md:flex">
                ...
                <div className="w-full mx-2 mt-4 md:mt-0">
                    ...
                    <input onChange={(e)=>setLanguage(e.target.value)} value={language} className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" type="text" required placeholder="java"/>
                </div>
            </div>
