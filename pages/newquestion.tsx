...
const Newquestion = () => {
  ...
  const submitHandler = async (): Promise<void> => {
    setLoading(true);
    try {
      await axios.post("https://heypiserver.herokuapp.com/askq", {
        title,
        description,
        language,
        token,
          ...
          <div className="mt-6 ">
            <div className="items-center -mx-2 md:flex">
              <div className="w-full mx-2 mt-4 md:mt-0">
                ...
                <input
                  ...
                  type="text"
                  required
                  placeholder="e.g An Api to get date ad time on mars"
                />
              </div>
            </div>
            ...
            <div className="w-full mt-4">
              ...
              <textarea
                ...
                value={description}
                className="block w-full h-60 px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"
                placeholder="e.g <></>"
              ></textarea>
            </div>
